...
#define SERVO_POWER_ENABLE_PIN_DEFAULT -1
#define BUS_VOLTAGE_PIN_DEFAULT -1
#define SERVO_VOLTAGE_PIN_DEFAULT -1
#define BRUSHED_MOTOR_DRIVE_DEFAULT {}
#define BRUSHED_DRIVE_PIN_1 -1
#define BRUSHED_DRIVE_PIN_2 -1
#define SERVO_POWER_ENABLE_PIN_DEFAULT -1
#define SERVO_VOLTAGE_PIN_DEFAULT -1
#define BUS_VOLTAGE_PIN_DEFAULT -1
#define PD_CFG_PIN_1 -1
#define PD_CFG_PIN_2 -1
#define PD_CFG_PIN_3 -1
#define PD_CFG_PINS_DEFAULT {}
